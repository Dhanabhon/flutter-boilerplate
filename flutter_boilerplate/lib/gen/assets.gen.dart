...
class $AssetsImagesGen {
  ...
  $AssetsImagesMockupGen get mockup => const $AssetsImagesMockupGen();
}

class $AssetsLocalesGen {
  const $AssetsLocalesGen();

  /// File path: assets/locales/en.arb
  String get en => 'assets/locales/en.arb';

  /// File path: assets/locales/th.arb
  String get th => 'assets/locales/th.arb';
...
class $AssetsImagesFlagsGen {
  ...
  /// File path: assets/images/flags/thailand.png
...
class $AssetsImagesMockupGen {
  const $AssetsImagesMockupGen();

  /// File path: assets/images/mockup/image457x344.png
  AssetGenImage get image457x344 =>
      const AssetGenImage('assets/images/mockup/image457x344.png');

  /// List of all assets
  List<AssetGenImage> get values => [image457x344];
}
